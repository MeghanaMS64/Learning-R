...
min_height - Valid max.height - Invalid (contains a dot) \_age - Valid .mass - Valid MaxLength - Valid min-length - Invalid (contains a hyphen) 2widths - Invalid (starts with a number) celsius2kelvin - Valid
...
mass \<- 47.5 \# mass = 47.5 age \<- 122 \# age = 122 mass \<- mass \* 2.3 \# mass = 109.25 (47.5 \* 2.3) age \<- age - 20 \# age = 102
...
mass > age  # This will return TRUE if mass is larger than age, otherwise FALSE
